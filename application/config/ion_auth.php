...
*/
$config['esquema_db']['sinfonica'] = 'sinfonica';
$config['tables']['users']           = 'users';
$config['tables']['groups']          = 'groups';
$config['tables']['users_groups']    = 'users_groups';
$config['tables']['login_attempts']  = 'login_attempts';
$config['tables']['app']  			 = 'app';
 ...
 */
$config['site_title']                 = "qf.com.ve";       // Site Title, example.com
$config['admin_email']                = "admin@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'usuario_sinfonica';           // Default group, use name
$config['admin_group']                = 'admin_sinfonica';      // Default administrators group, use name
