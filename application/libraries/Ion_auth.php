...
class Ion_auth
{
	...
	//** Funciones agregadas Ing. Joan Delgado
	
	/**
	 * Octiene nombre y apellido del usuario con sessión
	 */
	public function get_empresa()
	{
		$co_empresa=$this->ion_auth_model->user()->row();
		return $co_empresa->co_empresa;
	}

        public function get_nombres()
	{
		$usuario=$this->ion_auth_model->user()->row();
